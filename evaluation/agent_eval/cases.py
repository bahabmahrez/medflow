...
CASES: list[dict] = [
    ...
    },
    {
        ...
        "patient_context": {"active_meds": ["simvastatin", "clarithromycin"]},
        "expected_tool_sets": [
            ["get_drugs_by_class"],
    ...
    },
    {
        ...
        "answer_must_contain": ["not found", "not in the knowledge base", "cannot be assessed", "unknown"],
    ...
    },
    {
        ...
        "answer_must_contain": ["not found", "not in the knowledge base", "unresolved", "cannot be assessed"],
